...
namespace pav.GUILayer.Reportes.dsPerfilesTableAdapters {
    ...
    public partial class PerfilesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [BugTracker_72078].[dbo].[Perfiles] WHERE (([nombre] = ?) AND ([id_pe" +
                "rfil] = ?))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [BugTracker_72078].[dbo].[Perfiles] ([nombre]) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [BugTracker_72078].[dbo].[Perfiles] SET [nombre] = ? WHERE (([nombre] = ?)" +
                " AND ([id_perfil] = ?))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::pav.Properties.Settings.Default.ConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        nombre, id_perfil\r\nFROM            Perfiles";
        ...
        public virtual int Fill(dsPerfiles.PerfilesDataTable dataTable) {
        ...
        public virtual dsPerfiles.PerfilesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsPerfiles.PerfilesDataTable dataTable = new dsPerfiles.PerfilesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsPerfiles.PerfilesDataTable dataTable) {
        ...
        public virtual int Delete(string Original_nombre, int Original_id_perfil) {
        ...
        public virtual int Update(string nombre, string Original_nombre, int Original_id_perfil) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
